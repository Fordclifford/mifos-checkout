...
public class BudgetApiResource {
    ...
    private static final Set<String> RESPONSE_DATA_PARAMETERS = new HashSet<>(Arrays.asList("id", "amount", "name", "expenseAccountId","assetAccountId","disabled","assetAccountName","expenseAccountName","liabilityAccountName","liabilityAccountId","description","fromDate","toDate","cashAccountName","officeId"
           ));
